package me.synnk.event;

import java.lang.reflect.Method;
import java.util.HashMap;
import java.util.Iterator;
import java.util.Map;
import me.synnk.utils.ArrayUtils;
...
public class EventManager {
    ...
    private Map<Class<? extends Event>, ArrayUtils<Data>> REGISTRY_MAP = new HashMap();
    ...
    private void register(Method method, Object o) {
        ...
        if (REGISTRY_MAP.containsKey(clazz)) {
            ...
            REGISTRY_MAP.put((Class<? extends Event>) clazz, new ArrayUtils<Data>() {
                {
                    this.add(methodData);
                }
            });
    ...
    public void unregister(final Object o) {
        ...
        for (ArrayUtils<Data> flexibalArray : REGISTRY_MAP.values()) {
    ...
    public void cleanMap(boolean b) {
        ...
        Iterator<Map.Entry<Class<? extends Event>, ArrayUtils<Data>>> iterator = REGISTRY_MAP.entrySet().iterator();
    ...
    private void sortListValue(Class<? extends Event> clazz) {
        ...
        ArrayUtils<Data> flexibleArray = new ArrayUtils<Data>();

        for (byte b : VALUE_ARRAY) {
    ...
    public ArrayUtils<Data> get(final Class<? extends Event> clazz) {
